...
void AAuraEnemy::Die()
{
	...
	AuraAIController->GetBlackboardComponent()->SetValueAsBool(TEXT("IsDead"), true);
	Super::Die();
}
...
void AAuraEnemy::BeginPlay()
{
	...
	if(HasAuthority())
		UAuraAbilitySystem_BFL::GiveStartupAttributes(this,AbilitySystemComponent, CharacterClass);
